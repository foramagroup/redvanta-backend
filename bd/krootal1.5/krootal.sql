...
--
-- Hôte : 127.0.0.1
-- Généré le : ven. 27 mars 2026 à 19:34
...
INSERT INTO `cart_items` (`id`, `userId`, `companyId`, `productId`, `quantity`, `unitPrice`, `cardTypeId`, `designId`, `createdAt`, `updatedAt`, `packageTierId`, `totalCards`, `lineTotal`) VALUES
(500, 27, 26, 1, 1, 0.50, '1', 1, '2026-03-27 15:40:02', '2026-03-27 14:56:18', 14, 5, 2.50);
...
(26, 'smithbusinessname', NULL, NULL, 'smith@test.com', '6 95 41 53 03', NULL, NULL, 'direct', 2, NULL, 100, '#E10600', 1, 0, NULL, NULL, 0, NULL, 'https://www.google.com/maps/place/?q=place_id:ChIJD1GdyAYNYRARl8uGIwXFcO4', NULL, NULL, NULL, '2026-03-24 16:57:41', '2026-03-27 15:04:37', '$0', NULL, NULL, 0, 0, 'active', 'ChIJD1GdyAYNYRARl8uGIwXFcO4', 'https://search.google.com/local/writereview?placeid=ChIJD1GdyAYNYRARl8uGIwXFcO4');
...
CREATE TABLE `conversions` (
  ...
  `displayTotal` decimal(10,2) NOT NULL,
...
INSERT INTO `conversions` (`id`, `orderId`, `currency`, `rate`, `displayTotal`, `baseCurrency`, `baseTotal`, `createdAt`) VALUES
(1, 3, 'EUR', 1.000000, 11.69, 'EUR', 11.69, '2026-03-27 17:38:24');
...
INSERT INTO `designs` (`id`, `userId`, `companyId`, `productId`, `status`, `businessName`, `slogan`, `callToAction`, `ctaPaddingTop`, `googlePlaceId`, `googleReviewUrl`, `orientation`, `logoUrl`, `logoPosition`, `logoSize`, `colorMode`, `bgColor`, `textColor`, `accentColor`, `starColor`, `iconsColor`, `templateName`, `gradient1`, `gradient2`, `accentBand1`, `accentBand2`, `bandPosition`, `frontBandHeight`, `backBandHeight`, `businessFont`, `businessFontSize`, `businessFontWeight`, `businessFontSpacing`, `businessLineHeight`, `businessAlign`, `businessTextTransform`, `sloganFont`, `sloganFontSize`, `sloganFontWeight`, `sloganFontSpacing`, `sloganLineHeight`, `sloganAlign`, `sloganTextTransform`, `textShadow`, `frontInstruction1`, `frontInstruction2`, `backInstruction1`, `backInstruction2`, `instrFont`, `instrFontSize`, `instrFontWeight`, `instrFontSpacing`, `instrLineHeight`, `instrAlign`, `checkStrokeWidth`, `instrCheckboxStyle`, `qrCodeStyle`, `qrCodeSize`, `nfcIconSize`, `showNfcIcon`, `showGoogleIcon`, `googleLogoSize`, `cardModel`, `version`, `lastAutoSave`, `validatedAt`, `elementOffsets`, `createdAt`, `updatedAt`) VALUES
(1, 27, 26, 1, 'locked', 'Mazuel Santé', 'Votre bien-être au naturel', 'Scannez pour nous évaluer', 10, 'ChIJD1GdyAYNYRARl8uGIwXFcO4', 'https://search.google.com/local/writereview?placeid=ChIJD1GdyAYNYRARl8uGIwXFcO4', 'landscape', NULL, 'left', 32, 'single', '#0B0D0F', '#FFFFFF', '#22C55E', '#F59E0B', '#22C55E', NULL, '#0B0D0F', '#1A1A1A', '#E10600', '#FF4444', 'bottom', 22, 12, 'Space Grotesk', 18, 'Bold', 'Normal', '1.2', 'Left', 'uppercase', 'Inter', 12, 'Regular', 'Normal', '1.4', 'Left', 'none', 'None', 'Approach the phone to the card', 'Tap to leave a review', NULL, NULL, 'Space Grotesk', 10, 'Regular', 'Normal', '1.4', 'Left', 3.5, 'checkmark', 'right', 60, 16, 1, 1, 20, 'classic', 3, '2026-03-27 15:09:52', '2026-03-27 15:14:17', '{\"landscape\":{\"front\":{\"businessInfo\":{\"x\":50,\"y\":120},\"instructions\":{\"x\":50,\"y\":250}}}}', '2026-03-27 14:56:18', '2026-03-27 17:38:24');
...
--
-- Déchargement des données de la table `design_versions`
--

INSERT INTO `design_versions` (`id`, `designId`, `version`, `snapshot`, `savedAt`) VALUES
(1, 1, 1, '{\"businessName\":\"smithbusinessname\",\"slogan\":null,\"callToAction\":\"Powered by RedVanta\",\"ctaPaddingTop\":8,\"orientation\":\"landscape\",\"logoUrl\":null,\"logoPosition\":\"left\",\"logoSize\":32,\"colorMode\":\"single\",\"bgColor\":\"#0B0D0F\",\"textColor\":\"#FFFFFF\",\"accentColor\":\"#E10600\",\"starColor\":\"#F59E0B\",\"iconsColor\":\"#22C55E\",\"templateName\":null,\"gradient1\":\"#0B0D0F\",\"gradient2\":\"#1A1A1A\",\"accentBand1\":\"#E10600\",\"accentBand2\":\"#FF4444\",\"bandPosition\":\"bottom\",\"frontBandHeight\":22,\"backBandHeight\":12,\"showNfcIcon\":true,\"showGoogleIcon\":true,\"nfcIconSize\":16,\"googleLogoSize\":20,\"businessFont\":\"Space Grotesk\",\"businessFontSize\":16,\"businessFontWeight\":\"Bold\",\"businessFontSpacing\":\"Normal\",\"businessLineHeight\":\"1.2\",\"businessAlign\":\"Left\",\"businessTextTransform\":\"none\",\"sloganFont\":\"Inter\",\"sloganFontSize\":12,\"sloganFontWeight\":\"Regular\",\"sloganFontSpacing\":\"Normal\",\"sloganLineHeight\":\"1.4\",\"sloganAlign\":\"Left\",\"sloganTextTransform\":\"none\",\"textShadow\":\"None\",\"frontInstruction1\":\"Approach the phone to the card\",\"frontInstruction2\":\"Tap to leave a review\",\"backInstruction1\":null,\"backInstruction2\":null,\"instrFont\":\"Space Grotesk\",\"instrFontSize\":10,\"instrFontWeight\":\"Regular\",\"instrFontSpacing\":\"Normal\",\"instrLineHeight\":\"1.4\",\"instrAlign\":\"Left\",\"instrCheckboxStyle\":\"checkmark\",\"checkStrokeWidth\":3.5,\"qrCodeStyle\":\"Left\",\"qrCodeSize\":60,\"cardModel\":\"classic\",\"elementOffsets\":null}', '2026-03-27 15:04:37'),
(2, 1, 2, '{\"businessName\":\"Mazuel Santé\",\"slogan\":\"Votre bien-être au naturel\",\"callToAction\":\"Scannez pour nous évaluer\",\"ctaPaddingTop\":10,\"orientation\":\"landscape\",\"logoUrl\":null,\"logoPosition\":\"left\",\"logoSize\":32,\"colorMode\":\"single\",\"bgColor\":\"#0B0D0F\",\"textColor\":\"#FFFFFF\",\"accentColor\":\"#E10600\",\"starColor\":\"#F59E0B\",\"iconsColor\":\"#22C55E\",\"templateName\":null,\"gradient1\":\"#0B0D0F\",\"gradient2\":\"#1A1A1A\",\"accentBand1\":\"#E10600\",\"accentBand2\":\"#FF4444\",\"bandPosition\":\"bottom\",\"frontBandHeight\":22,\"backBandHeight\":12,\"showNfcIcon\":true,\"showGoogleIcon\":true,\"nfcIconSize\":16,\"googleLogoSize\":20,\"businessFont\":\"Space Grotesk\",\"businessFontSize\":16,\"businessFontWeight\":\"Bold\",\"businessFontSpacing\":\"Normal\",\"businessLineHeight\":\"1.2\",\"businessAlign\":\"Left\",\"businessTextTransform\":\"none\",\"sloganFont\":\"Inter\",\"sloganFontSize\":12,\"sloganFontWeight\":\"Regular\",\"sloganFontSpacing\":\"Normal\",\"sloganLineHeight\":\"1.4\",\"sloganAlign\":\"Left\",\"sloganTextTransform\":\"none\",\"textShadow\":\"None\",\"frontInstruction1\":\"Approach the phone to the card\",\"frontInstruction2\":\"Tap to leave a review\",\"backInstruction1\":null,\"backInstruction2\":null,\"instrFont\":\"Space Grotesk\",\"instrFontSize\":10,\"instrFontWeight\":\"Regular\",\"instrFontSpacing\":\"Normal\",\"instrLineHeight\":\"1.4\",\"instrAlign\":\"Left\",\"instrCheckboxStyle\":\"checkmark\",\"checkStrokeWidth\":3.5,\"qrCodeStyle\":\"Left\",\"qrCodeSize\":60,\"cardModel\":\"classic\",\"elementOffsets\":null}', '2026-03-27 15:09:52');
...
--
-- Déchargement des données de la table `google_place_cache`
--

INSERT INTO `google_place_cache` (`id`, `placeId`, `name`, `formattedAddress`, `phone`, `website`, `lat`, `lng`, `rating`, `userRatingsTotal`, `reviewUrl`, `photoReference`, `photoUrl`, `types`, `cachedAt`, `expiresAt`) VALUES
(1, 'ChIJD1GdyAYNYRARl8uGIwXFcO4', 'Haurizon News', 'Makepe, en face, Eglise St Monique, Douala, Cameroun', '6 95 41 53 03', 'https://haurizonnews.com/', 4.0842688, 9.7542124, NULL, NULL, 'https://search.google.com/local/writereview?placeid=ChIJD1GdyAYNYRARl8uGIwXFcO4', 'AU_ZVEERKMUHmUl3-m9NvVtynmpHBt3Gym_Yod0jAAz4rhiQ2EbijKzpHcxNPFL11TXEFSB9I0j4fmNCpdKgOyJezXJhPK8nhNvCvxlPV1JVLFqLetsZbD5RP2xZkGveKFZf_f96H1cZIf1JWEcdbxU-VCg1uMXVe31JyRJE0f2hhqVKV4Jz1kFmd2YFuGJxjJcOvLD9a-l53KWnYjKqneR8WL1Wf8AB0FAJHbuu6pg56pM4NUdh19oFgLhrii9NaM7-asU_zIdlnzLYGzgSNDahwu9gLvpD6YGDY9VOk_IB-Ns', 'https://maps.googleapis.com/maps/api/place/photo?maxwidth=400&photo_reference=AU_ZVEERKMUHmUl3-m9NvVtynmpHBt3Gym_Yod0jAAz4rhiQ2EbijKzpHcxNPFL11TXEFSB9I0j4fmNCpdKgOyJezXJhPK8nhNvCvxlPV1JVLFqLetsZbD5RP2xZkGveKFZf_f96H1cZIf1JWEcdbxU-VCg1uMXVe31JyRJE0f2hhqVKV4Jz1kFmd2YFuGJxjJcOvLD9a-l53KWnYjKqneR8WL1Wf8AB0FAJHbuu6pg56pM4NUdh19oFgLhrii9NaM7-asU_zIdlnzLYGzgSNDahwu9gLvpD6YGDY9VOk_IB-Ns&key=AIzaSyDIDmPSQ9S5DTfX9Vxs5OjzpLAMUgSDAUA', '[\"establishment\",\"point_of_interest\"]', '2026-03-27 14:14:34', '2026-04-26 14:14:34');
...
CREATE TABLE `invoices` (
  ...
  `companyId` int(11) NOT NULL,
  `userId` int(10) UNSIGNED NOT NULL,
  `status` enum('draft','sent','paid','overdue','cancelled','refunded') NOT NULL DEFAULT 'paid',
  ...
  `displayTotal` decimal(10,2) DEFAULT NULL,
  ...
  `billingVat` varchar(50) DEFAULT NULL,
  `notes` text DEFAULT NULL,
  `terms` text DEFAULT NULL,
  `reference` varchar(100) DEFAULT NULL,
  `isRecurring` tinyint(1) NOT NULL DEFAULT 0,
  `recurringInterval` varchar(20) DEFAULT NULL,
...
INSERT INTO `order` (`id`, `userId`, `companyId`, `orderNumber`, `status`, `subtotal`, `shippingCost`, `total`, `currency`, `displayTotal`, `exchangeRate`, `shippingFullName`, `shippingAddress`, `shippingCity`, `shippingState`, `shippingZip`, `shippingCountry`, `shippingMethod`, `stripePaymentIntentId`, `stripeClientSecret`, `paidAt`, `confirmationEmailSentAt`, `createdAt`, `updatedAt`) VALUES
(3, 27, 26, 'ORD-2026-000001', 'pending', 2.50, 9.19, 11.69, 'EUR', 11.69, 1.000000, 'Mfeutgnia Rodrigue', '123 Rue de la Santé', 'Douala', 'Littoral', '00237', 'Cameroon', 'standard', 'pi_3TFeKyB2wAb6tenq1Jqf8QOW', 'pi_3TFeKyB2wAb6tenq1Jqf8QOW_secret_lJTyfSfK3nVrw6uHyahu29L0X', NULL, NULL, '2026-03-27 17:38:24', '2026-03-27 17:38:24');
...
INSERT INTO `order_items` (`id`, `orderId`, `productId`, `designId`, `cardTypeId`, `quantity`, `unitPrice`, `totalPrice`, `packageTierId`, `totalCards`) VALUES
(3, 3, 1, 1, '1', 5, 0.50, 2.50, 14, 5);
...
(1, 'stripe', 'sk_test_placeholder', 'sk_test_placeholder', NULL, 'test', 'Active', 1, '135+', '2.9% + $0.30', '2026-03-12 15:51:16', '2026-03-27 18:08:40'),
...
ALTER TABLE `invoices`
  ...
  ADD KEY `idxInvCompany` (`companyId`),
  ADD KEY `idxInvStatus` (`status`),
  ADD KEY `idxInvDate` (`invoiceDate`),
  ADD KEY `fkInvUser` (`userId`);
...
ALTER TABLE `invoice_items`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idxIiInvoice` (`invoiceId`);
...
ALTER TABLE `refunds`
  ADD PRIMARY KEY (`id`),
  ADD KEY `idxRefInvoice` (`invoiceId`);
...
--
ALTER TABLE `conversions`
  ADD CONSTRAINT `fkConvOrder` FOREIGN KEY (`orderId`) REFERENCES `order` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `invoices`
  ADD CONSTRAINT `fkInvCompany` FOREIGN KEY (`companyId`) REFERENCES `companies` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `fkInvOrder` FOREIGN KEY (`orderId`) REFERENCES `order` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `fkInvUser` FOREIGN KEY (`userId`) REFERENCES `users` (`id`) ON DELETE CASCADE;

--
-- Contraintes pour la table `invoice_items`
--
ALTER TABLE `invoice_items`
  ADD CONSTRAINT `fkIiInvoice` FOREIGN KEY (`invoiceId`) REFERENCES `invoices` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `refunds`
  ADD CONSTRAINT `idxRefInvoice` FOREIGN KEY (`invoiceId`) REFERENCES `invoices` (`id`) ON DELETE CASCADE;

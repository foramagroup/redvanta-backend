...
function formatTemplateForProduct(template) {
  return {
    ...
    serialNumberTextColor: template.serialNumberTextColor,
    serialNumberBgColor: template.serialNumberBgColor,
    serialNumberFontSize: template.serialNumberFontSize,
    serialNumberPaddingX: template.serialNumberPaddingX,
    serialNumberPaddingY: template.serialNumberPaddingY,
    serialNumberRadius: template.serialNumberRadius,
